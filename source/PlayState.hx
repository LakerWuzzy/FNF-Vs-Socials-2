	...
	override public function create()
	{
		...
		if (SONG.stage == null) {
			switch(storyWeek)
			{
				...
				case 7: stageCheck = 'gog_stage';
				case 8: stageCheck = 'yt_stage';
				case 9: stageCheck = 'discord_stage';
		...
		switch(stageCheck)
		{
			...
			case 'gog_stage':
				{
						defaultCamZoom = 0.9;
						curStage = 'gog_stage';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('gog_stage'));
						bg.antialiasing = true;
			...
			case 'yt_stage':
				{
						defaultCamZoom = 0.9;
						curStage = 'yt_stage';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('yt_stage'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
			...
			case 'discord_stage':
				{
						defaultCamZoom = 0.9;
						curStage = 'discord_stage';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('discord_stage'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
